      ...
      <Content>
        ...
        <Schedule>
          ...
          <Section>
            ...
            <SectionContent>
              {morningAvailability.map(({ hourFomatted, available, hour }) => (
                <Hour
                  enabled={available}
                ...
                >
                  <HourText>{hourFomatted}</HourText>
                </Hour>
              ))}
            </SectionContent>
          </Section>
        ...
        <CreateAppointButton onPress={handleCreateAppointment}>
          <CreateAppointButtonText>Agendar</CreateAppointButtonText>
        </CreateAppointButton>
      </Content>
    </Container>
  );
